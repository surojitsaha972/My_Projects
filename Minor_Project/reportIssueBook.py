...
# Form implementation generated from reading ui file 'reportIssueBook.ui'
#
...
class Ui_issueBook(object):
    def setupUi(self, issueBook):
        ...
        issueBook.resize(800, 600)
        issueBook.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        # self.frame_2.setMinimumSize(QtCore.QSize(950, 0))
        self.frame_2.setMinimumSize(QtCore.QSize(970, 0))
        ...
        self.pdf.setMaximumSize(QtCore.QSize(16777215, 41))
        ...
        self.menubar = QtWidgets.QMenuBar(issueBook)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 21))
        self.menubar.setObjectName("menubar")
        issueBook.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(issueBook)
        self.statusbar.setObjectName("statusbar")
        issueBook.setStatusBar(self.statusbar)
        ...
        self.pdf.clicked.connect(issueBook.close)

    def retranslateUi(self, issueBook):
        _translate = QtCore.QCoreApplication.translate
        issueBook.setWindowTitle(_translate("issueBook", "All Issue Report"))
        self.label.setText(_translate("issueBook", "Issue Book Report"))
        item = self.table.horizontalHeaderItem(0)
        item.setText(_translate("issueBook", "Std Roll"))
        item = self.table.horizontalHeaderItem(1)
        item.setText(_translate("issueBook", "AccessionNo"))
        item = self.table.horizontalHeaderItem(2)
        item.setText(_translate("issueBook", "SubjectName"))
        item = self.table.horizontalHeaderItem(3)
        item.setText(_translate("issueBook", "BookName"))
        item = self.table.horizontalHeaderItem(4)
        item.setText(_translate("issueBook", "AuthorName"))
        item = self.table.horizontalHeaderItem(5)
        item.setText(_translate("issueBook", "Edition"))
        item = self.table.horizontalHeaderItem(6)
        item.setText(_translate("issueBook", "Issue Date"))
        item = self.table.horizontalHeaderItem(7)
        item.setText(_translate("issueBook", "Due Date"))
        item = self.table.horizontalHeaderItem(8)
        item.setText(_translate("issueBook", "Return Date"))
        self.pdf.setText(_translate("issueBook", "Generate PDF"))

    def issueBook(self):
        con = sqlite3.connect("projectDB.db")
        cur = con.cursor()
        q = "select SID,BookID,SubjectName,BookName,AuthorName,Edition,IssueDate,DueDate,ReturnDate from issueBook where ReturnDate != ?"
        cur.execute(q,("NULL",))
        res= cur.fetchall()
        if res == []:
            msg = QMessageBox()
